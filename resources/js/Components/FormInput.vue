...
<template>
    <div :class="['w-full', type !== 'hidden' ? 'mb-4' : '']">
        ...
        <button v-else-if="type === 'button'" :type="type" @click="emit('click')" :disabled="disabled"
            class="w-full px-5 py-2.5 text-md font-medium text-white bg-blue-950 rounded-lg hover:bg-[#E55207] focus:ring-4 focus:outline-none focus:ring-gray-300 transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed">
            {{ label || modelValue }}
        </button>
