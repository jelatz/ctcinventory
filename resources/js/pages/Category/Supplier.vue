<template>
    <div class="p-10">
        <h1 class="text-2xl font-bold mb-5">Suppliers</h1>
        <div>
            <button
            ...
            <Modal :isOpen="showModal" @close="showModal = false" modalSize="w-1/2">
                ...
                <form>
                    <FormInput formLabel="Supplier Name" labelFor="supplier" formInputType="input" v-model="supplier"
                        inputClass="w-full" :formError="false" errorMessage="Please enter a supplier"
