<template>
    <div
        class="bg-[#e9e9e9] w-full lg:w-[30%] min-h-screen h-full flex flex-col justify-start pt-52 items-stretch text-center"
    >
        <img :src="'/storage/images/ctc_logo.png'" alt="Logo" class="my-5 w-20 mx-auto" />
